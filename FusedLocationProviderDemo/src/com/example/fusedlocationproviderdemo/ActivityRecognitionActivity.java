...
public class ActivityRecognitionActivity extends Activity implements ConnectionCallbacks, OnConnectionFailedListener
{
	...
	{
		Toast.makeText(ActivityRecognitionActivity.this, "Connection Failed", Toast.LENGTH_SHORT).show();
	}
	...
	{
		Toast.makeText(ActivityRecognitionActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
