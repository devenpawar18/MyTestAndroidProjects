...
import com.arbetsformedlingen.externalutils.facebook.android.AsyncFacebookRunner;
import com.arbetsformedlingen.externalutils.facebook.android.AsyncFacebookRunner.RequestListener;
import com.arbetsformedlingen.externalutils.facebook.android.DialogError;
import com.arbetsformedlingen.externalutils.facebook.android.Facebook;
...
import com.arbetsformedlingen.externalutils.facebook.android.FacebookError;
import com.arbetsformedlingen.externalutils.facebook.android.SessionEvents;
import com.arbetsformedlingen.externalutils.facebook.android.SessionEvents.AuthListener;
import com.arbetsformedlingen.externalutils.facebook.android.SessionStore;
...
public class FacebookManager  {
	...
	//private static final String kApiKey = "f1f58f359c1712352b930c82907477cc";//yaRSS
    //private static final String kApiKey = "c5f732428e3c689623168b7b9e8fbf86";//xpress it for iphone
//    private static final String kApiKey = "8dd6d2c272557103d07c1d613d19cd9d";//xpressit for android
    private static final String kApiKey = "8dd6d2c272557103d07c1d613d19cd9d";
	// Enter either your API secret or a callback URL (as described in documentation):
    //private static final String kApiSecret = "57f55ad6a6ce45f6fa9a8bed951fc3e3";//"5782aae6148ab675874a9c6aeba5dbf8"
    //private static final String kApiSecret = "e70fc66e0b5b8d1acb9b98dcc33543ba";//xpress it for iphone
//    private static final String kApiSecret = "7121870dcfa4e76d23cd8c25c3be68ac";//xpress it for android
    private static final String kApiSecret = "7121870dcfa4e76d23cd8c25c3be68ac";//xpress it for android
    	...
    	Thread timeLineThread = new Thread(new Runnable(){
			...
			public void run() {
		    	...
		    	try {
					...
					((FBResponseListener)context).responseSuccess(requestcode, null);
