...
public class DetailActivity extends Activity implements GetAppsServiceListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		IntentFilter filter = new IntentFilter(BroadcastDemoActivity.FILTER_STRING);
		r = new MyBroadcast();
		...
		btn.setOnClickListener(new OnClickListener()
		{
			...
			{
				Intent intent = new Intent(DetailActivity.this, BroadcastDemoActivity.class);
