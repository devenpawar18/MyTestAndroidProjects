...
public class TabBarExample extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		/*
		 * TabSpec used to create a new tab. By using TabSpec only we can able to setContent to the
		 * tab. By using TabSpec setIndicator() we can set name to tab.
		 */
		...
		thirdTabSpec.setIndicator("Deven").setContent(new Intent(this, SecondTab.class));
