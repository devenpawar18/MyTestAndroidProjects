...
import com.sharing.externalutils.linkedinapi.client.LinkedInApiClientFactory;
...
import com.sharing.externalutils.linkedinapi.client.oauth.LinkedInRequestToken;
...
public class LinkedInManager {
	...
	public Boolean connect() {
		try {
			...
			linkedInToken = oAuthService.getOAuthRequestToken(SharingActivity.CALLBACK_URL);
