...
import com.arbetsformedlingen.externalutils.linkedinapi.schema.MemberGroup;
import com.arbetsformedlingen.externalutils.linkedinapi.schema.SiteGroupRequest;
