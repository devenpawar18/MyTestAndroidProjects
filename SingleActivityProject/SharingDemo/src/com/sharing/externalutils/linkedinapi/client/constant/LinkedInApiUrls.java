 ...
 *
 */
package com.sharing.externalutils.linkedinapi.client.constant;
...
import com.sharing.externalutils.linkedinapi.client.enumeration.FieldEnum;
...
public final class LinkedInApiUrls {
	...
	public static final String API_URLS_FILE = "com/sharing/externalutils/linkedinapi/client/constant/LinkedInApiUrls.properties";
	...
	static {
		try {
			linkedInApiUrls.load(LinkedInApiUrls.class.getClassLoader()
	...
	public static final String GET_PROFILE_FOR_CURRENT_USER = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getProfileForCurrentUser");

	/** The Constant GET_PROFILE_BY_ID. */
	public static final String GET_PROFILE_BY_ID = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getProfileById");

	/** The Constant GET_PROFILE_BY_URL. */
	public static final String GET_PROFILE_BY_URL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getProfileByUrl");

	/** The Constant SEARCH_PEOPLE. */
	public static final String SEARCH_PEOPLE = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.searchPeople");

	/** The Constant POST_UPDATE. */
	public static final String POST_UPDATE = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.postUpdate");

	/** The Constant POST_STATUS. */
	public static final String POST_STATUS = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.postStatus");

	/** The Constant POST_COMMENT. */
	public static final String POST_COMMENT = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.postComment");

	/** The Constant SEND_MESSAGE. */
	public static final String SEND_MESSAGE = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.sendMessage");

	/** The Constant LINKED_IN_OAUTH_REQUEST_TOKEN_URL. */
	public static final String LINKED_IN_OAUTH_REQUEST_TOKEN_URL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.oauth.requestToken");

	/** The Constant LINKED_IN_OAUTH_AUTHORIZE_URL. */
	public static final String LINKED_IN_OAUTH_AUTHORIZE_URL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.oauth.authorize");

	/** The Constant LINKED_IN_OAUTH_ACCESS_TOKEN_URL. */
	public static final String LINKED_IN_OAUTH_ACCESS_TOKEN_URL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.oauth.accessToken");

	/** The Constant NETWORK_UPDATES. */
	public static final String NETWORK_UPDATES = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.networkUpdates");

	/** The Constant NETWORK_UPDATE_COMMENTS. */
	public static final String NETWORK_UPDATE_COMMENTS = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.networkUpdateComments");

	/** The Constant GET_CONNECTIONS_FOR_CURRENT_USER. */
	public static final String GET_CONNECTIONS_FOR_CURRENT_USER = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getConnectionsForCurrentUser");

	/** The Constant GET_CONNECTIONS_BY_ID. */
	public static final String GET_CONNECTIONS_BY_ID = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getConnectionsById");

	/** The Constant GET_CONNECTIONS_BY_EMAIL. */
	public static final String GET_CONNECTIONS_BY_EMAIL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getConnectionsByEmail");

	/** The Constant GET_CONNECTIONS_BY_URL. */
	public static final String GET_CONNECTIONS_BY_URL = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.getConnectionsByUrl");

	/** The Constant SEND_MESSAGE_PERSON_PATH. */
	public static final String SEND_MESSAGE_PERSON_PATH = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.messagePersonPath");

	/** The Constant SEND_INVITE_ID_PERSON_PATH. */
	public static final String SEND_INVITE_ID_PERSON_PATH = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.inviteIdPersonPath");

	/** The Constant SEND_INVITE_EMAIL_PERSON_PATH. */
	public static final String SEND_INVITE_EMAIL_PERSON_PATH = linkedInApiUrls
			.getProperty("com.sharing.externalutils.linkedinapi.client.inviteEmailPersonPath");
	...
	public static class LinkedInApiUrlBuilder {
		 ...
		 * @return the linked in api url builder
		 */
		public LinkedInApiUrlBuilder withParameters(String name,
		 ...
		 * @return the linked in api url builder
		 */
		public LinkedInApiUrlBuilder withParameterEnumSet(String name,
				Set<? extends FieldEnum> enumSet) {
		 ...
		 * @return the linked in api url builder
		 */
		public LinkedInApiUrlBuilder withParameterEnum(String name,
				FieldEnum value) {
		 ...
		 * @return the linked in api url builder
		 */
		public LinkedInApiUrlBuilder withParameterEnumMap(
				Map<? extends FieldEnum, String> enumMap) {
		 ...
		 * @return the linked in api url builder
		 */
		public LinkedInApiUrlBuilder withFieldEnumSet(String name,
				Set<? extends FieldEnum> enumSet) {
